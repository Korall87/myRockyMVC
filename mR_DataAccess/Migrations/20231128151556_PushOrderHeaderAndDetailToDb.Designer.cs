...
namespace mR_DataAccess.Migrations
{
    ...
    [Migration("20231128151556_PushOrderHeaderAndDetailToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mR_Models.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("mR_Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("mR_Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("mR_Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("mR_Models.InquiryDetail", b =>
                {
                    b.HasOne("mR_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("mR_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("mR_Models.InquiryHeader", b =>
                {
                    b.HasOne("mR_Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("mR_Models.OrderDetail", b =>
                {
                    b.HasOne("mR_Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("mR_Models.OrderHeader", b =>
                {
                    b.HasOne("mR_Models.ApplicationUser", "CreatedBy")
                        .WithMany()
